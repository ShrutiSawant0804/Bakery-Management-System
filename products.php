        ...
        <div style="background-color: black;">
            ...
            <div class="container">
                <div class="jumbotron" style="background-color: white";>
                    <h1>Welcome to Sweet Bite Cake Shop!</h1>
                    <p>Sweet Bite is India’s top Cake brand that helps you celebrate special moments by delivering faobulous tasty cakes to your loved ones. You can find many lovely cakes for all special days like Birthdays, Anniversaries, Valentine's day etc. Our range of yummy cakes will be delivered to all major cities in under 2-4 hours.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mix 1.jpg" alt="Mix Fruit">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Berry Burst Cake</b></h3>
                                    <p>Price: Rs. 450.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now
                                        </a></p>
                                        <?php
                                        }
                                        else{
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mix 2.jpg" alt="Mix Fruit">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Berry Burst Vanila</b></h3>
                                    <p>Price: Rs. 460.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mix 4.jpg" alt="Mix Fruit">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Rose Berry Fruit</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mix 3.jpg" alt="Fruit Cake">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Blue Berry Pie</b></h3>
                                    <p>Price: Rs. 550.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Red 1.jpg" alt="Red Velvet">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Strawberry Red Velvet</b></h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Red 2.jpg" alt="Red Velvet">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Candy Crush Cake</b></h3>
                                    <p>Price: Rs. 600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Red 3.jpg" alt="Red Velvet">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Red Wine Cake</b></h3>
                                    <p>Price: Rs. 700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Truffle tarle.jpg" alt="Truffle tarle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Coco Truffle Tarle Cake</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/truffel 1.jpeg" alt="truffle tarle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Cerry Truffle</b></h3>
                                    <p>Price: Rs. 400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/truffel 2.jpeg" alt="truffle tarle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Lichi Truffle</b></h3>
                                    <p>Price: Rs. 440.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/truffle 3.jpeg" alt="truffel tarle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Chestnut Mausse Cake</b></h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/donut (1).jpeg" alt="donut">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Donuts</b></h3>
                                    <h4>Pack of 12 Donuts</h4>
                                    <p>Price: Rs. 600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/donut (2).jpeg" alt="donut">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Chocolate Donuts</b></h3>
                                    <h4>Pack of 2 Donuts</h4>
                                    <p>Price: Rs. 70.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/donut (3).jpeg" alt="donut">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Nut Donuts</b></h3>
                                    <h4>Pack of 3 Donuts</h4>
                                    <p>Price: Rs. 180.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Malabar coast cardamon.jpg" alt="Malabar">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Malabar Coast Cardamon</b></h3>
                                    <p>Price: Rs. 800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Malabar 1.jpg" alt="Birthday Card (pink)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Malabar Coast Cardamon</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Malabar 2.jpg" alt="Birthday Card (blue)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Malabar Coast Cardamon</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Malabar 3.jpg" alt="Birthday Card (cake)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Malabar Coast Cardamon</b></h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Blood 1.jpg" alt="Farewell Card (ribbon)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Blood Coffee Orange</b></h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Blood 2.jpg" alt="Farewell Card (black)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Blood Red Orange</b></h3>
                                    <p>Price: Rs. 700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Blood 3.jpg" alt="Farewell Card (white)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Butterfly Orange</b></h3>
                                    <p>Price: Rs. 700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Blood 4.jpg" alt="Farewell Card (flower)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Cone Ora Cake</b></h3>
                                    <p>Price: Rs. 800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Roses 1.jpg" alt="Opening Ceremony Card (flower)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Mango Cup</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Roses 2.jpg" alt="Opening Ceremony Card (blue)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Coco Cup</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Roses 3.jpg" alt="Opening Ceremony Card (crown)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Chary Cup</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Roses 4.jpg" alt="Opening Ceremony Card (red)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Cram Cup</b></h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bundt 1.jpeg" alt="Wedding Ceremony Card (flower)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Red Cream Bundt</b></h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bundt 2.jpeg" alt="Wedding Ceremony Card (photo)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Hot Bundt</b></h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bundt cake.jpeg" alt="Wedding Ceremony Card (heart)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Red Berry Bundt</b></h3>
                                    <p>Price: Rs. 700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bundt 4.jpeg" alt="Wedding Ceremony Card (white)">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3><b>Choco Chip Bundt</b></h3>
                                    <p>Price: Rs. 800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
